...
const FEATURES = {
  ...
  WALLET_EVENT_SUBSCRIPTIONS: {
    ...
    image: 'walletEventSubscriptions',
  },
  DATA_VISUALIZATION: {
    description:
...
const FeaturesList: FC = () => {
  return (
    <section className={'grid grid-cols-12 gap-5'}>
      <div className={'col-span-7 bg-ob-extras-white/50 flex-col flex gap-16 p-6 rounded-[32px]'}>
      ...
      <div className={'col-span-5 bg-ob-extras-white/50 flex-col flex gap-16 p-6 rounded-[32px]'}>
        <p className={'text-base max-w-[457px] font-normal'}>
      ...
      <div className={'col-span-12 bg-ob-extras-white/50 flex-col flex gap-16 p-6 rounded-[32px]'}>
        <p className={'text-base max-w-[457px] font-normal'}>
